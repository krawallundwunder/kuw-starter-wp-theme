...
{
  wp_enqueue_style('tailwind-min-css', get_template_directory_uri() . '/assets/css/dist/style.min.css', array(), _S_VERSION);
	wp_enqueue_script('custom-javascript', get_template_directory_uri() . '/assets/js/dist/bundle.min.js', array(), _S_VERSION, true);
