...
{
  wp_enqueue_style('tailwind-min-css', get_template_directory_uri() . '/assets/css/tailwind.min.css', array(), _S_VERSION);
	wp_enqueue_script('custom-javascript', get_template_directory_uri() . '/assets/js/main.min.js', array(), _S_VERSION, true);
