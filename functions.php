...
{
	wp_enqueue_style('tailwind-css', get_template_directory_uri() . '/assets/css/tailwind.min.css', array(), _S_VERSION);

  wp_enqueue_style('main-min-css', get_template_directory_uri() . '/assets/css/main.min.css', array(), _S_VERSION);

	wp_enqueue_script('custom-javascript', get_template_directory_uri() . '/assets/js/custom.js', array(), _S_VERSION, true);
