...
$bg_style = $bg
  ? 'background-image: linear-gradient(rgba(0, 0, 0, 0.625), rgba(0, 0, 0, 0.625)), url(' .
    $bg .
    ')'
  : '';
?>
...
<section
	class="acf-block hero-section<?php
 echo $bg ? ' has-bg-img' : '';
 echo $is_front_page ? ' is-front-page' : '';
 ?>"
		...
		<?php if ($button_primary): ?>
			<div class="mt-5">
				...
				<?php if ($button_secondary): ?>
					<a class="button button-secondary" href="<?php echo $button_secondary[
       'url'
     ]; ?>">
