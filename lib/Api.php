...
class Api
{
  ...
  {
    $data = apply_filters('Flynt/addComponentData', $data, $componentName);

    $output = apply_filters('Flynt/renderComponent', null, $componentName, $data);
  ...
  public static function registerHooks(): void
  {
    add_filter(
      ...
      function ($output, $componentName, $data) {
    ...
    add_filter(
      ...
      function ($data, $componentName) {
        return apply_filters("Flynt/addComponentData?name={$componentName}", $data, $componentName);
      },
      10,
      2,
    );
