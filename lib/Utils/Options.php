...
class Options
{
  ...
  public static function init(): void
  {
    ...
    add_action('current_screen', function ($currentScreen): void {
      ...
      foreach (static::OPTION_TYPES as $optionType => $option) {
        ...
        $subPageId = strtolower(sanitize_title($menuTitle) . '_page_' . $optionType);
        $isCurrentPage =
   ...
   * @return void
   */
  protected static function createOptionSubPage(
    string $optionType,
   ...
   */
  public static function addTranslatable(
    string $scope,
    array $fields,
